          ...
          <div className="bg-zinc-900/30 border border-white/5 rounded-[32px] p-8 space-y-6">
            <div className="flex items-center justify-between p-4 rounded-2xl bg-zinc-900/50 border border-white/5">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Bot Sync</h4>
            ...
            <form action={pruneStaleData} className="flex items-center justify-between p-4 rounded-2xl bg-zinc-900/50 border border-white/5">
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-xl bg-red-500/10 flex items-center justify-center text-red-400 border border-red-500/10">
                  <Database size={18} />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-white">Prune Stale Auth Rows</h4>
                  <p className="text-[11px] text-zinc-500 font-medium">Delete expired sessions and magic-link verification tokens.</p>
                </div>
              </div>
              <button type="submit" className="px-4 py-2 rounded-xl bg-zinc-800 text-white text-xs font-bold hover:bg-zinc-700 transition-all active:scale-95 border border-white/5">
                Prune
              </button>
            </form>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-zinc-900/30 border border-white/5 rounded-[32px] p-8 space-y-6">
             ...
             <div className="space-y-4 pt-2">
                ...
                <p className="text-[10px] text-zinc-600 px-1 italic">Shared secret for internal service communication. Coming soon.</p>
             </div>
          </div>
        </div>
      </div>
